      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-4 md:p-8 lg:p-10 ml-0 md:ml-72 transition-all duration-300">
          <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow p-6">
            <h2 className="text-2xl font-bold text-red-700 mb-6 text-center">Dịch vụ chuyển phòng</h2>
            <div className="text-gray-600 text-center">Trang đăng ký chuyển phòng (coming soon).</div>
          </div>
        </main>
      </div>
    </div>
